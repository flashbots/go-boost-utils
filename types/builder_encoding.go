...
// Hash: 447f4f6535c9d23767cffae55a21b9152b127ea3d6328e6bcc84e484d80e9bb1
package types
...
// MarshalSSZ ssz marshals the BidTraceMessage object
func (b *BidTraceMessage) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BidTraceMessage object to a target array
func (b *BidTraceMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
...
// UnmarshalSSZ ssz unmarshals the BidTraceMessage object
func (b *BidTraceMessage) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 220 {
		return ssz.ErrSize
	...
	// Field (6) 'Value'
	copy(b.Value[:], buf[188:220])

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the BidTraceMessage object
func (b *BidTraceMessage) SizeSSZ() (size int) {
	size = 220
	return
}

// HashTreeRoot ssz hashes the BidTraceMessage object
func (b *BidTraceMessage) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BidTraceMessage object with a hasher
func (b *BidTraceMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the BidTraceMessage object
func (b *BidTraceMessage) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(b)
}
...
func (b *BuilderSubmitBlockResponseMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.BidUnverified == nil {
		b.BidUnverified = new(BidTraceMessage)
	}
...
func (b *BuilderSubmitBlockResponseMessage) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.BidUnverified.UnmarshalSSZ(buf[8:228]); err != nil {
		return err
	}
